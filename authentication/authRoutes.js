...
Router.post('/login', (req, res, next)=>{
    ...
    passport.authenticate("local", { session:false }, (err, user, info )=>{
        ...
        // The login property is added to the request by passport package to create login session
        req.login(user, {session:false}, (err)=>{
            ...
            // Destructure email from the user object- so I do not get the password
            const {email}=user;
